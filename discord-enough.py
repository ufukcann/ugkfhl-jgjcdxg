...
TOKEN = "MTA1MzU5NTA4MTg1ODM2MzQzMg.GB1U3f.CpG_nBpgbu_ZnCYtXuOTkt7kXCMkiremmC4jhc"
gif = "https://media.tenor.com/uC06rDXhadsAAAAd/soviet-union-stalin.gif"
adet = 10
saniye = 0
...
async def on_ready():
    ...
    activity = discord.Activity(type=discord.ActivityType.playing, name="Annenle")
...
async def on_message(message):
    ...
    if len(message.content.split(" ")) == 2 and message.content.split(" ")[0] == "!sms" and message.channel.id == 1065720438958862389:
        print("okkk")
